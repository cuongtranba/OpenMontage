---
id: c3-110
c3-seal: cfab189a3152c76fbb49bec31c6f8731144da5d3cca1adf84953db2c0fb24b08
title: Provider Tools & Selectors
type: component
parent: c3-1
goal: Concrete generation and post-production capabilities behind one contract.
uses:
...
| Category | Feature |
| Code | tools/audio/, tools/video/, tools/graphics/, tools/publishers/, tools/analysis/, tools/avatar/, tools/enhancement/, tools/capture/, tools/character/, tools/subtitle/ |
...
| ref-instruction-layering | ref | Agents read the tool's agent_skills before use | binding | tts_selector, image_selector, video_selector all gate dispatch on agent_skills read |
...
| tts_selector / image_selector / video_selector | IN | Capability-level request; routes by user preference > availability > discovery order | Python API | tools/audio/tts_selector.py |
...
| --- | --- | --- | --- |
| N.A - not applicable | N.A - not applicable | N.A - not applicable | c3-110 |
| N.A - not applicable | N.A - not applicable | N.A - not applicable | c3-110 |
